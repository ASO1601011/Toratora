...
public class MainActivity extends Activity implements OnClickListener {
    private ImageButton otherGuBtn;
    private ImageButton otherChokiBtn;
    private ImageButton otherPaBtn;
    private ImageButton myGuBtn;
    private ImageButton myChokiBtn;
    private ImageButton myPaBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 自分の手
        myGuBtn = (ImageButton) findViewById(R.id.my_gu);
        myChokiBtn = (ImageButton) findViewById(R.id.my_choki);
        myPaBtn = (ImageButton) findViewById(R.id.my_pa);
        // 相手の手
        otherGuBtn = (ImageButton) findViewById(R.id.other_gu);
        otherChokiBtn = (ImageButton) findViewById(R.id.other_choki);
        otherPaBtn = (ImageButton) findViewById(R.id.other_pa);
        // 自分の手にイベントリスナーをセット
